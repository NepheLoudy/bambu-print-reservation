...
module.exports = {
  ...
  projects: [
    ...
    },
    {
      ...
      notes: '多人接单批次已随 v61（f6f73e2）推送：出站 fetch 15s 超时、审批人解析失败不缓存自愈、接单队列复用全量记录、静默积压挪址 QUIET_BACKLOG_FILE；v64 起同群并发接单串行化（补充负责人合并写不再互相覆盖）；v65 起搬运人员口径=补充负责人全员（指定负责人公示即绑定入补充负责人，专项搬运废止；指定负责人本身不再直接入看板）；工单播报/接单/结单/审批自动通过事件写入动态广场（机器人项目看板）',
    },
    {
      id: 'duty',
      name: 'duty-bot',
